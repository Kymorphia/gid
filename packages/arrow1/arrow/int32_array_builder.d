...
class Int32ArrayBuilder : arrow.array_builder.ArrayBuilder
{
  ...
  static GType _getGType() nothrow
  {
    ...
    return cast(void function())garrow_int32_array_builder_get_type != &gidSymbolNotFound ? garrow_int32_array_builder_get_type() : cast(GType)0;
  }
  ...
  override Int32ArrayBuilder self() nothrow
  {
    return this;
  }
  ...
  */
  static Int32ArrayBuilderGidBuilder builder() nothrow
  {
  ...
  bool append(int value)
  {
    bool _retval;
    GError *_err;
    _retval = cast(bool)garrow_int32_array_builder_append(cast(GArrowInt32ArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
  ...
  bool appendValue(int value)
  {
    bool _retval;
    GError *_err;
    _retval = cast(bool)garrow_int32_array_builder_append_value(cast(GArrowInt32ArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
  ...
  */
  bool appendValues(int[] values, bool[] isValids = null)
  {
    ...
    auto _values = values.ptr ? cast(const(int)*)values.ptr : [int.init].ptr;
    ...
    GError *_err;
    _retval = cast(bool)garrow_int32_array_builder_append_values(cast(GArrowInt32ArrayBuilder*)this._cPtr, _values, _valuesLength, _isValids, _isValidsLength, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
...
final class Int32ArrayBuilderGidBuilder : Int32ArrayBuilderGidBuilderImpl!Int32ArrayBuilderGidBuilder
{
  /**
      ...
      Returns: New object
  */
  Int32ArrayBuilder build() nothrow
  {
