...
class FloatArrayBuilder : arrow.array_builder.ArrayBuilder
{
  ...
  override FloatArrayBuilder self() nothrow
  {
    return this;
  }
  ...
  */
  static FloatArrayBuilderGidBuilder builder() nothrow
  {
    return new FloatArrayBuilderGidBuilder;
  }
  ...
  bool append(float value)
  {
    bool _retval;
    GError *_err;
    _retval = cast(bool)garrow_float_array_builder_append(cast(GArrowFloatArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
  ...
  bool appendValue(float value)
  {
    bool _retval;
    GError *_err;
    _retval = cast(bool)garrow_float_array_builder_append_value(cast(GArrowFloatArrayBuilder*)this._cPtr, value, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
  ...
  */
  bool appendValues(float[] values, bool[] isValids = null)
  {
    ...
    auto _values = values.ptr ? cast(const(float)*)values.ptr : [float.init].ptr;
    ...
    GError *_err;
    _retval = cast(bool)garrow_float_array_builder_append_values(cast(GArrowFloatArrayBuilder*)this._cPtr, _values, _valuesLength, _isValids, _isValidsLength, &_err);
    if (_err)
      throw new ErrorWrap(_err);
    return _retval;
  }
...
final class FloatArrayBuilderGidBuilder : FloatArrayBuilderGidBuilderImpl!FloatArrayBuilderGidBuilder
{
  /**
      ...
      Returns: New object
  */
  FloatArrayBuilder build() nothrow
  {
