...
class Region : gobject.object.ObjectWrap
{
  ...
  */
  ...
  /**
      Get `buffer` property.
      Returns: The [gtk.text_buffer.TextBuffer]. The #GtkSourceRegion has a weak reference to the
        buffer.
  */
...
class RegionGidBuilderImpl(T) : gobject.object.ObjectWrapGidBuilderImpl!T
{
  ...
  /**
      Set `buffer` property.
      Params:
        propval = The [gtk.text_buffer.TextBuffer]. The #GtkSourceRegion has a weak reference to the
          buffer.
