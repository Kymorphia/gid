...
class ContextMenuItem : gobject.initially_unowned.InitiallyUnowned
{
  ...
  */
  static webkit.context_menu_item.ContextMenuItem newFromGaction(gio.action.Action action, string label, glib.variant.Variant target = null) nothrow
  {
  ...
  /**
      ...
      Returns: the newly created #WebKitContextMenuItem object.
  */
  static webkit.context_menu_item.ContextMenuItem newFromStockAction(webkit.types.ContextMenuAction action) nothrow
  {
    WebKitContextMenuItem* _cretval;
  ...
  /**
      ...
      Returns: the newly created #WebKitContextMenuItem object.
  */
  static webkit.context_menu_item.ContextMenuItem newFromStockActionWithLabel(webkit.types.ContextMenuAction action, string label) nothrow
  {
    WebKitContextMenuItem* _cretval;
    const(char)* _label = label.toCString!(No.Malloc, No.Nullable);
  ...
  /**
      ...
      Returns: the newly created #WebKitContextMenuItem object.
  */
  static webkit.context_menu_item.ContextMenuItem newSeparator() nothrow
  {
    WebKitContextMenuItem* _cretval;
  ...
  /**
      ...
      Returns: the newly created #WebKitContextMenuItem object.
  */
  static webkit.context_menu_item.ContextMenuItem newWithSubmenu(string label, webkit.context_menu.ContextMenu submenu) nothrow
  {
    WebKitContextMenuItem* _cretval;
    const(char)* _label = label.toCString!(No.Malloc, No.Nullable);
  ...
  */
  webkit.types.ContextMenuAction getStockAction() nothrow
  {
  ...
  */
  webkit.context_menu.ContextMenu getSubmenu() nothrow
  {
    WebKitContextMenu* _cretval;
    _cretval = webkit_context_menu_item_get_submenu(cast(WebKitContextMenuItem*)this._cPtr);
    auto _retval = gobject.object.ObjectWrap._getDObject!(webkit.context_menu.ContextMenu)(cast(WebKitContextMenu*)_cretval, No.Take);
    return _retval;
  }
  ...
  */
  void setSubmenu(webkit.context_menu.ContextMenu submenu = null) nothrow
  {
