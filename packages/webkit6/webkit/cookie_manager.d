...
*/
class CookieManager : gobject.object.ObjectWrap
{
  ...
  override CookieManager self() nothrow
  {
    return this;
  }
  ...
  */
  static CookieManagerGidBuilder builder() nothrow
  {
  ...
  */
  void addCookie(soup.cookie.Cookie cookie, gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
  ...
  */
  ...
  /**
      ...
      Params:
        ...
        callback = a #GAsyncReadyCallback to call when the request is satisfied
  */
  void deleteCookie(soup.cookie.Cookie cookie, gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
    extern(C) void _callbackCallback(GObject* sourceObject, GAsyncResult* res, void* data) nothrow
    {
      ptrThawGC(data);
  ...
  */
  ...
  /**
      ...
      Params:
        ...
        callback = a #GAsyncReadyCallback to call when the request is satisfied
  */
  void getAcceptPolicy(gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
    extern(C) void _callbackCallback(GObject* sourceObject, GAsyncResult* res, void* data) nothrow
    {
      ptrThawGC(data);
  ...
  */
  void getAllCookies(gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
    extern(C) void _callbackCallback(GObject* sourceObject, GAsyncResult* res, void* data) nothrow
    {
      ptrThawGC(data);
  ...
  */
  ...
  /**
      ...
      Params:
        ...
        callback = a #GAsyncReadyCallback to call when the request is satisfied
  */
  void getCookies(string uri, gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
    extern(C) void _callbackCallback(GObject* sourceObject, GAsyncResult* res, void* data) nothrow
    {
      ptrThawGC(data);
  ...
  */
  ...
  /**
      ...
      Params:
        ...
        callback = (closure user_data): a #GAsyncReadyCallback to call when the request is satisfied
  */
  void replaceCookies(soup.cookie.Cookie[] cookies, gio.cancellable.Cancellable cancellable = null, gio.types.AsyncReadyCallback callback = null) nothrow
  {
    extern(C) void _callbackCallback(GObject* sourceObject, GAsyncResult* res, void* data) nothrow
    {
      ptrThawGC(data);
  ...
  */
  void setAcceptPolicy(webkit.types.CookieAcceptPolicy policy) nothrow
  {
  ...
  */
  ...
  && Parameters!T.length < 2)
  {
    extern(C) void _cmarshal(GClosure* _closure, GValue* _returnValue, uint _nParams, const(GValue)* _paramVals, void* _invocHint, void* _marshalData) nothrow
    {
      ...
      {
        gidInvokeCallbackExceptionHandler(e, "webkit.cookie_manager.CookieManager.changed");
      }
    }
