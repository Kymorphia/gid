...
class ContextMenu : gobject.object.ObjectWrap
{
  ...
  /**
      Get builder for [webkit.context_menu.ContextMenu]
  ...
  */
  ...
  /**
      ...
      Returns: The newly created #WebKitContextMenu object
  */
  static webkit.context_menu.ContextMenu newWithItems(webkit.context_menu_item.ContextMenuItem[] items) nothrow
  {
    WebKitContextMenu* _cretval;
  ...
  */
  void append(webkit.context_menu_item.ContextMenuItem item) nothrow
  {
  ...
  */
  webkit.context_menu_item.ContextMenuItem first() nothrow
  {
  ...
  */
  webkit.context_menu_item.ContextMenuItem getItemAtPosition(uint position) nothrow
  {
    WebKitContextMenuItem* _cretval;
  ...
  */
  webkit.context_menu_item.ContextMenuItem[] getItems() nothrow
  {
    GList* _cretval;
  ...
  */
  void insert(webkit.context_menu_item.ContextMenuItem item, int position) nothrow
  {
  ...
  /**
      ...
      Returns: the last #WebKitContextMenuItem of menu,
           or null if the #WebKitContextMenu is empty.
  */
  webkit.context_menu_item.ContextMenuItem last() nothrow
  {
    WebKitContextMenuItem* _cretval;
  ...
  */
  void moveItem(webkit.context_menu_item.ContextMenuItem item, int position) nothrow
  {
  ...
  /**
      ...
      Params:
        item = the #WebKitContextMenuItem to add
  */
  void prepend(webkit.context_menu_item.ContextMenuItem item) nothrow
  {
  ...
  */
  void remove(webkit.context_menu_item.ContextMenuItem item) nothrow
  {
...
/// Fluent builder implementation template for [webkit.context_menu.ContextMenu]
