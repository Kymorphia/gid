...
class Seat : gobject.object.ObjectWrap
{
  ...
  */
  ...
  /**
      ...
      Returns: [gdk.display.Display] of this seat.
  */
  ...
  */
  gdk.device.Device[] getDevices(gdk.types.SeatCapabilities capabilities) nothrow
  {
    GList* _cretval;
    _cretval = gdk_seat_get_devices(cast(GdkSeat*)this._cPtr, capabilities);
  ...
  */
  gdk.device_tool.DeviceTool[] getTools() nothrow
  {
    GList* _cretval;
    _cretval = gdk_seat_get_tools(cast(GdkSeat*)this._cPtr);
...
class SeatGidBuilderImpl(T) : gobject.object.ObjectWrapGidBuilderImpl!T
{
  ...
  /**
      ...
      Params:
        propval = [gdk.display.Display] of this seat.
