...
class CellRendererToggle : gtk.cell_renderer.CellRenderer
{
  ...
  */
  ...
  /** */
  @property int indicatorSize() nothrow
  {
    return gobject.object.ObjectWrap.getProperty!(int)("indicator-size");
  }

  /** */
  @property void indicatorSize(int propval) nothrow
  {
    gobject.object.ObjectWrap.setProperty!(int)("indicator-size", propval);
  }
...
class CellRendererToggleGidBuilderImpl(T) : gtk.cell_renderer.CellRendererGidBuilderImpl!T
{
  ...
  /** */
  T indicatorSize(int propval) nothrow
  {
    return setProperty("indicator-size", propval);
  }
