...
class TextMark : gobject.object.ObjectWrap
{
  ...
  */
  ...
  /**
      ...
      Returns: Whether the mark has left gravity. When text is inserted at the mark’s
...
class TextMarkGidBuilderImpl(T) : gobject.object.ObjectWrapGidBuilderImpl!T
{
  ...
  /**
      ...
      Params:
        propval = Whether the mark has left gravity. When text is inserted at the mark’s
          current location, if the mark has left gravity it will be moved
          to the left of the newly-inserted text, otherwise to the right.
