...
class PrintOperation : gobject.object.ObjectWrap, gtk.print_operation_preview.PrintOperationPreview
{
  ...
  */
  ...
  /**
      ...
      Returns: The #GtkPageSetup used by default.
  ...
  */
  ...
  /**
      ...
      Returns: If true, page size combo box and orientation combo box are embedded into page setup page.
  */
  ...
  */
  ...
  /**
      ...
      Returns: The #GtkPrintSettings used for initializing the dialog.
  ...
  /**
      ...
      Params:
        callback = signal callback delegate or function to connect
          ...
          `preview` the #GtkPrintOperationPreview for the current operation (optional)
  
          `context` the #GtkPrintContext that will be used (optional)
  
          `parent` the #GtkWindow to use as window parent, or null (optional)
