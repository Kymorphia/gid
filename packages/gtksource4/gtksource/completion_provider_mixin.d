...
template CompletionProviderT()
{
  ...
  */
  ...
  {
    bool _retval;
    _retval = cast(bool)gtk_source_completion_provider_activate_proposal(cast(GtkSourceCompletionProvider*)this._cPtr, proposal ? cast(GtkSourceCompletionProposal*)(cast(gobject.object.ObjectWrap)proposal)._cPtr(No.Dup) : null, cast(GtkTextIter*)&iter);
    return _retval;
  }
  ...
  */
  ...
  {
    bool _retval;
    _retval = cast(bool)gtk_source_completion_provider_get_start_iter(cast(GtkSourceCompletionProvider*)this._cPtr, context ? cast(GtkSourceCompletionContext*)context._cPtr(No.Dup) : null, proposal ? cast(GtkSourceCompletionProposal*)(cast(gobject.object.ObjectWrap)proposal)._cPtr(No.Dup) : null, cast(GtkTextIter*)&iter);
    return _retval;
  }
